...
Normally, Director of Technology is a caretaker role, ensuring what was made previous years is updated for the current year\'s conference. But I wasn\'t content to just be caretaker. Instead, I evaluated the state of the conference\'s branding and found a few things. In previous years, we were simultaneously using...
